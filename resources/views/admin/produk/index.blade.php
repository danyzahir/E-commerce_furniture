        ...
        <main class="flex-1 p-6 md:p-10 transition-all duration-200">
            ...
            <div class="flex flex-col items-start mb-6 gap-3">
                ...
                <button onclick="openModal()"
                    class="bg-sky-700 hover:bg-sky-800 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center justify-center gap-2">
                        ...
                        @forelse ($produks as $produk)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-3 px-2">
                                    ...
                                    @else
                                        <div
                                            class="w-16 h-16 flex items-center justify-center bg-gray-100 text-gray-400 rounded-lg border">
                                            No Img</div>
                                    @endif
                                </td>
                                <td class="py-3 px-2 font-medium text-gray-800">{{ $produk->nama_produk }}</td>
                                <td class="py-3 px-2">{{ $produk->category ? $produk->category->nama : '-' }}</td>
                                <!-- Kolom kategori -->
                                <td class="py-3 px-2">{{ $produk->kuantitas }}</td>
                                <td class="py-3 px-2 font-semibold text-sky-700">Rp
